  ...
  $(".topest li").hover(
    function() {
      $(this)
        .find("img")
        .stop()
        .animate({ left: $(this).innerWidth() }, 500);
    },
    function() {
      $(this)
        .find("img")
  ...
  $(".zs_gd_bka li").hover(
    function() {
      $(this)
        .find("img:last")
        .stop()
        .animate({ top: -$(this).innerHeight() }, 500);
    },
    function() {
      $(this)
        .find("img:last")
